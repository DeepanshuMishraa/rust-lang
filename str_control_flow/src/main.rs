...
fn count(arg: String) {
    ...
    loop{
        println!("{}", arg);
        // You can use a counter variable to keep track of how many times you've printed `arg`.
        // For example, you could use a variable `count` and increment it each time through the loop.
        // When `count` reaches 8, you can break out of the loop.
        // Here's a simple way to do it:
        static mut COUNT: i32 = 0; // Using a static mutable variable for simplicity in this example
        unsafe {
            COUNT += 1;
            if COUNT >= 8 {
                break;
